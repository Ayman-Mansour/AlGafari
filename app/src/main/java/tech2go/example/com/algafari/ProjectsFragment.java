...
public class ProjectsFragment extends Fragment {
   ...
   public View rootView;
    ...
    private RVArrayAdapter_Fragment_projects adapter;
    @Override
...
//        ListView listview = (ListView) rootView.findViewById(R.id.list_a);
        android.support.v7.widget.RecyclerView recyclerView = (android.support.v7.widget.RecyclerView) rootView.findViewById(R.id.customers_list);
        adapter = new RVArrayAdapter_Fragment_projects(getContext(),getData());
    ...
    public List<Information> getData() {
        ...
        String[] sections_description = getResources().getStringArray(R.array.projects);
