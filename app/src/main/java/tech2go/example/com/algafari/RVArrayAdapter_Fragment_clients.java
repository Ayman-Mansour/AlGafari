...
public class RVArrayAdapter_Fragment_clients extends RecyclerView.Adapter<RVArrayAdapter_Fragment_clients.MyViewHolder> {
    private LayoutInflater inflater;
    private List<Information> data = Collections.emptyList();
    private final static int FADE_DURATION = 1000; // in milliseconds
    private Context context;
    public RVArrayAdapter_Fragment_clients(Context context, List<Information> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = inflater.inflate(R.layout.custom_clients_list, viewGroup, false);
